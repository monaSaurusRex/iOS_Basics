 ...
 *The journey of a thousand miles begins with one step* - **Lao Tzu**
 ...
 This part of the course is aimed at people with little to no Swift programming knowledge. This part of the course could still be useful to beginner to intermediate level Swift programmers because we touch on Swift API design style and Swift 5 specific quirks that you may not know about.
 ...
 We start this part of the course with an `Imperative` style paradigm to writing code. This means we write our code as a set of step-by-step instructions. This is a good way to learn code in the beginning before we get into `Obect Oriented Programming` and `Functional` style paradigms later on in the course.
